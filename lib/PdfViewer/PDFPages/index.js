...
var PdfPages = exports.PdfPages = /*#__PURE__*/function (_React$Component) {
  ...
  function PdfPages() {
    ...
    _defineProperty(_assertThisInitialized(_this), "setupViewer", function () {
      ...
      _pdf_viewer.PDFJS.externalLinkTarget = _pdf_viewer.PDFJS.LinkTarget.PARENT;
...
var _default = exports["default"] = PdfPages;